...
JAZZMIN_SETTINGS = {
    ...
    "site_title": "Uychilikmiz.uz Admin",

    # Title on the login screen (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_header": "Uychilikmiz.uz",

    # Title on the brand (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_brand": "Uychilikmiz.uz",
    ...
    "order_with_respect_to": [
        "news.Category", "news.New", "news.Contact",
    ],
    ...
    "icons": {
        ...
        "news.New": "fas fa-newspaper",
        "news.Contact": "fas fa-bullhorn",
        "news.Category": "fas fa-solid fa-bars",
    },
